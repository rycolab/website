+++
title = 'Philosophy of Language and Computation I, Spring 2026'
subtitle = 'ETH Zürich: [Course catalog](https://www.vvz.ethz.ch/Vorlesungsverzeichnis/lerneinheit.view?semkez=2026S&ansicht=ALLE&lerneinheitId=201420&lang=en)'
summary = 'This graduate class is designed to help you understand the philosophical underpinnings of modern work in natural language processing (NLP), most of which centered around statistical machine learning applied to natural language data.'
...
The course will require a weekly reading of around 30 pages (with relatively high variance at times) and weekly tasks related to the reading (free-form response or in-text comments), which are to be completed online. The weekly tasks are short and not graded; however, to pass the class, at least 70% of the tasks must be completed. See [this document](https://drive.google.com/file/d/1xXWCNQa28jLfgmpUA54wOJSQoXoFCZfG/view?usp=sharing) for the guidelines on the weekly tasks. The final grade will be based on one class presentation (in teams) and one individual oral evaluation, supported by a short text (1-2 pages maximum), at the end of the semester. The oral evaluation will include a presentation of a topic of the student's choice, followed by an open discussion with the teaching team. The topic must correspond to a different module than the one already addressed in the class presentation, and the students will be expected to explore the relation of the topics discussed in class to work not presented in class, focusing on the connection between the philosophy of language and NLP. For example, discussing how recent NLP papers implicitly assumed or contradicted a structuralist or a logicist perspective on language would be a good topic.
...
- [Presentation grading rubric](https://drive.google.com/file/d/1ilmJF1Ur-N4twhgMHRN-_fJR0WPQiOfM/view?usp=sharing)
- [Oral grading rubric](https://drive.google.com/file/d/1zgwJ5515SYtz5M9q09Qc_qB1fJBfINCD/view?usp=sharing)
...
- [Oral exam grading rubric](https://drive.google.com/file/d/1zgwJ5515SYtz5M9q09Qc_qB1fJBfINCD/view?usp=sharing)
- [Presentation grading rubric](https://drive.google.com/file/d/1ilmJF1Ur-N4twhgMHRN-_fJR0WPQiOfM/view?usp=sharing)
- [Guidelines for weekly assignments](https://drive.google.com/file/d/1xXWCNQa28jLfgmpUA54wOJSQoXoFCZfG/view?usp=sharing)
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <a href="https://arxiv.org/pdf/1902.07181.pdf" target="_blank"><b>Andreas (2019)</b></a> 
      </td>
    </tr>  
    <tr>
      <th scope="row">6</th>
    ...
    <tr>
      ...
      <td>
        <!-- <a href="https://drive.google.com/file/d/1ymIuj8WsWFwr9rP-v3dFA-MC8TrrhVfg/view?usp=sharing" target="_blank"><b>Harris</b> (1951)</a>, -->
    ...
    <tr>
      ...
      <td>
        ...
        <a href="https://arxiv.org/pdf/1508.06615.pdf" target="_blank"><b>Kim et al. (2015)</b></a>, 
        ...
        <a href="https://arxiv.org/pdf/2211.09761.pdf" target="_blank"><b>Nawrot et al. (2023)</b></a>
    ...
    <tr>
      <th scope="row">10</th>
      <td>28.04.26</td>
      <td rowspan="4" style="vertical-align : middle;text-align:center;" align="center"><b>Recursive Structure:<br>The Computational Nature of Language</b></td>
    ...
    <tr>
      ...
      <td>
        ...
        <a href="https://aclanthology.org/P14-1022.pdf" target="_blank"><b>Hall et al. (2014)</b></a>, 
...
- Sanderson (2017-2025). [3blue1brown](https://www.3blue1brown.com): Neural Networks. The basics of neural networks, and the math behind how they learn.
- Karpathy (2022). [nanoGPT](https://github.com/karpathy/nanoGPT).
- Wolfram (2024). [What Is ChatGPT Doing … and Why Does It Work?](https://writings.stephenwolfram.com/2023/02/what-is-chatgpt-doing-and-why-does-it-work/)
