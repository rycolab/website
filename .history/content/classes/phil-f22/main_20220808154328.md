...
**Lectures:** 	
Tue	16-18, HG E 1.1. The lectures will be given in person. [This](https://ethz.zoom.us/j/65437442808) recurring Zoom meeting will be used throughout the semester for people who want to tune in remotely. The password can be found on Moodle. 

**Discussion Sections:** 
Tue	18-19	HG E 1.1. 

**Course Live Chat:** 
To provide an easier way to communicate with the teaching team and your colleagues, we have set up a chat server. 
It is hosted on ETH servers and it will be the main communication hub for the course! We encourage you to sign up and participate in the discussions there.
The link to the channel is, as the ones above, posted on the course Moodle page.
